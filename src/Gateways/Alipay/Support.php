...
use Smalls\Pay\Gateways\AliPay;
use Smalls\Pay\Supports\Arr;
...
class Support
{
    ...
    protected static function processingApiResult($data, $result): Collection
    {
        ...
        if (!isset($result['sign']) || '10000' != $result[$method]['code']) {
            throw new GatewayException('Get Alipay API Error:' . $result[$method]['msg'] . (isset($result[$method]['sub_code']) ? (' - ' . $result[$method]['sub_code']) : ''));
        }
